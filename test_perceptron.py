...
if __name__ == "__main__":
    ...
    print("Input : Output")
    print('(1 1) ->', perceptron.predict_one_individual(pd.DataFrame({'A': [1], 'B': [1]})), ': excepted 1.')
    print('(1 0) ->', perceptron.predict_one_individual(pd.DataFrame({'A': [1], 'B': [0]})), ': excepted -1.')
    print('(0 1) ->', perceptron.predict_one_individual(pd.DataFrame({'A': [0], 'B': [1]})), ': excepted -1.')
    print('(0 0) ->', perceptron.predict_one_individual(pd.DataFrame({'A': [0], 'B': [0]})), ': excepted -1.')
    ...
    print("Input : Output")
    print('(1 1) ->', perceptron2.predict_one_individual(pd.DataFrame({'A': [1], 'B': [1]})), ': excepted 1.')
    print('(1 0) ->', perceptron2.predict_one_individual(pd.DataFrame({'A': [1], 'B': [0]})), ': excepted 1.')
    print('(0 1) ->', perceptron2.predict_one_individual(pd.DataFrame({'A': [0], 'B': [1]})), ': excepted 1.')
    print('(0 0) ->', perceptron2.predict_one_individual(pd.DataFrame({'A': [0], 'B': [0]})), ': excepted -1.')
    ...
    print('(1 11) ->', perceptron3.predict_one_individual(pd.DataFrame({'X1': [1], 'X2': [11]})), ': excepted 1.')
    print('(2 12) ->', perceptron3.predict_one_individual(pd.DataFrame({'X1': [2], 'X2': [12]})), ': excepted 1.')
    print('(10 0) ->', perceptron3.predict_one_individual(pd.DataFrame({'X1': [10], 'X2': [0]})), ': excepted -1.')
    print('(12 1) ->', perceptron3.predict_one_individual(pd.DataFrame({'X1': [12], 'X2': [1]})), ': excepted -1.')
